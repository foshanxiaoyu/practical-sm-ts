...
export default function UnstyledSelectTransitions() {
  ...
  return (
    <div className={isDarkMode ? 'dark ' : ''}>
      <div className="flex-warp relative w-full border-red-400 ">
        <Image src='/car-logo.svg' width={20} height={20} className='absoute top-[14px] ml-4' alt='Car logo' />
        <Select placeholder="Volkswagen" >
    ...
    <BaseOption
      ...
      slotProps={{
        root: ({ selected, highlighted, disabled }) => ({
          className: `list-none p-2 rounded-lg cursor-default last-of-type:border-b-0 ${getOptionColorclassName(
